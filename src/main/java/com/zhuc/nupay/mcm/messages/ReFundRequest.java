 ...
 * 
 * data 节 封包结构: ....
 * | 15字merchantId.| 8字节terminalId | 24字节卡号 | 4字节交易金额|8字节时间戳...
 * 
 */
public class ReFundRequest extends PosMcRequest{
    ...
    protected void parseData() throws InvalidMessageException {
        try {
            ...
            this.setTimestamp(Tools.bcd2timestamp(tsp));//Tools.bytes2long(tsp));
